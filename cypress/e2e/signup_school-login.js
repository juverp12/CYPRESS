...
describe('School Sign up and Log In', () => {
    ...
    const alternateEmail = 'school6@gmail.com';
    const username = 'School66';
    const password = 'School66';
    const passwordConfirm = 'School66';
    ...
    it('School Admin should be able to sign up', () => {
        ...
        cy.get('button[class="h-full w-full prevent-select button primary"]')
            .parents('app-button[class="button primary ng-tns-c94-0 ng-star-inserted"]')
            .contains('Next')
            .should('be.visible')
            .click()
        cy.wait(500)
