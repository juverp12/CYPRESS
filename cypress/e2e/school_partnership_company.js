...
describe('OJTPH Log in', () => {
    ...
    const schoolusername = 'School4!';
    const schoolpassword = 'School4!';
    ...
    it('School should be able to send a partnership', () => {
    ...
    it('Company should be able to accept the partnership', () => {
        cy.on('uncaught:exception', () => {
            return false
        })
    ...
    it('School should be able to proceed to the MOA Process', () => {
    ...
    it('Company should be able to download the MOA for review', () => {
        cy.on('uncaught:exception', () => {
            return false
        })
