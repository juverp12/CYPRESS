...
describe('Company Sign up and Log In', () => {
    ...
    const username = 'Company12345';
    const password = 'Company12345';
    const passwordConfirm = 'Company12345';
    ...
    beforeEach(() => {
        ...
        it('Company Admin should be able to sign up', () => {
            ...
            cy.get('button[class="h-full w-full prevent-select button primary"]')
                .parents('app-button[class="button primary ng-tns-c93-0 ng-star-inserted"]')
                .contains('Next')
                .should('be.visible')
                .click()
            cy.wait(500)
